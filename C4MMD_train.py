...
from transformers import ViTImageProcessor, ViTModel, XLMRobertaModel
...
language_model = 'D:/model_code/C4MMD-main-origin/xlm-roberta-base'
'''
...
'''
vision_model = 'D:/model_code/C4MMD-main-origin/vit-base-patch16-224'
'''
...
train_data = 'D:/model_code/C4MMD-main-origin/data/new_train_data.json'
'''
your training data, you can get data type in the data folder. For example:
data/train_data.json
'''
val_data = 'D:/model_code/C4MMD-main-origin/data/new_val_data.json'
'''
your training data, you can get data type in the data folder. For example:
data/val_data.json
'''
test_data = 'D:/model_code/C4MMD-main-origin/data/new_test_data.json'
'''
your training data, you can get data type in the data folder. For example:
data/test_data.json
'''
...
class VitXLMRDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        line = self.datas[idx]
        img, text, lable, lable2 = line['images_name'], line['text'], int(line['metaphor occurrence']), line['metaphor category']
...
def evaluation(model, dataloader, epoch, val=True, save=False):
    ...
    if save:
        ...
        save_json('compare_test_result.json', saved_list)
