...
load_path = 'D:/model_code/C4MMD-main-origin/data'
'''
...
save_json('D:/model_code/C4MMD-main-origin/data/train_data.json', convert_list2dict(train_data, c_head))
save_json('D:/model_code/C4MMD-main-origin/data/val_data.json', convert_list2dict(val_data, c_head))
save_json('D:/model_code/C4MMD-main-origin/data/test_data.json', convert_list2dict(test_data, c_head))